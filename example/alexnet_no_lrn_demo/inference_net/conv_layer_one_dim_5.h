...
#ifndef _CONV_LAYER_5_H_
#define _CONV_LAYER_5_H_
...
private:
    ...
    int out_data_size;
public:
    conv_layer_5() : conv_layer_number(0) { out_data_size = (_INPUT_SIZE_ + _CONV_PADDING_ * 2 - _CONV_KERNEL_SIZE_) / _CONV_STRIDE_ + 1;
    };
