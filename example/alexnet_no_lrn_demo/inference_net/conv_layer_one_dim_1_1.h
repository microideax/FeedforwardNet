...
#ifndef _CONV_LAYER_1_1_H_
#define _CONV_LAYER_1_1_H_
...
class conv_layer_1_1 {

private:
    int conv_layer_number;
    int out_data_size;
public:
    conv_layer_1_1() : conv_layer_number(0) { out_data_size = (_INPUT_SIZE_ + _CONV_PADDING_ * 2 - _CONV_KERNEL_SIZE_) / _CONV_STRIDE_ + 1;
    };
