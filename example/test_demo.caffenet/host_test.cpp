...
void runTest(int argc, char** argv)
{
    ...
    //load val image file *****************************
    string image_dir = "../net_inputs/test_imgs/ILSVRC2012_img_val/ILSVRC2012_val_00000003.JPEG";
...
*/
    ...
    double time_exe = (double)(tv4.tv_sec - tv3.tv_sec) + (double)(tv4.tv_usec - tv3.tv_usec) / 1000000;
    cout<<"Total time of inference execution = "<< time_exe <<" seconds"<<endl;
