...
typedef ap_fixed<24,16> data_type;

#define BUF_1_X_DIM 16
#define BUF_1_Y_DIM 32
#define BUF_1_Z_DIM 32

#define BUF_2_X_DIM 16
#define BUF_2_Y_DIM 32
#define BUF_2_Z_DIM 32
