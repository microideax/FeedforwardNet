...
#pragma HLS INTERFACE m_axi depth=96*55*55 port=output_temp_2
	...
	conv_acc<data_type, data_type_w, data_type_o, 2, 1, 16, 16> convAcc1;//{0<Tm<=M;0<Tn<=N;0<Tr<=R;0<Tc<=C;}
...
//	convAcc1.conv_layer_acc(3, 11, 96, 55, 55, 4, 0, output_temp_1, conv_weight_port, conv_bias_port, output_temp_2);
    convAcc1.conv_layer_acc(1, 11, 6, 55, 55, 4, 0, output_temp_1, conv_weight_port, conv_bias_port, output_temp_2);
