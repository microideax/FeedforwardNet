...
#pragma HLS INTERFACE m_axi depth=55 port=output_2
   ...
   //C1.conv_layer_a_no_activation(in_data_buf, conv_weight_port, conv_bias_port, output_temp_1);
   ...
   //C2.conv_layer_a(activation_type, output_temp_2, conv_weight_port + shift_weight_conv2, conv_bias_port + shift_bias_conv2, output_temp_1);
   ...
   //C3.conv_layer_a(activation_type, output_temp_2, conv_weight_port + shift_weight_conv3, conv_bias_port + shift_bias_conv3, output_temp_1);
   ...
   //F1.fc_layer_a_no_activation(output_temp_2, fc_weight_port, fc_bias_port, output_temp_1);
   convAcc1.conv_layer_acc_noact(64, 4, 10, 1, 1, 4, 0, output_temp_2, fc_weight_port, fc_bias_port, output_temp_1, 0, 0);
   for (int i = 0; i < 10; i++) {
      fc_4_out_a[i] = output_temp_1[i];
   }
