...
conv_acc<data_type, data_type_w, data_type_o, 16, 4, 13, 13, 1, 5> convAcc2;//{0<Tm<=M;0<Tn<=N;0<Tr<=R;0<Tc<=C;}
...
void ave_pool_layer_new(
    ...
    avePoolAcc1.ave_pool_layer_acc(R_in, C_in, N, K, R, C, S, P, act, in_data, out_data);
