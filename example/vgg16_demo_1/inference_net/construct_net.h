...
//}
    ...
    conv_max_pool_layer_new(64, 3, 2, 64, 224, 224, 112, 112, 1, 2, 1, output_temp_1,conv_weight_port, conv_bias_port, output_temp_2, shift_weight_conv_1_2, shift_bias_conv_1_2,0,0);
    for(int i = 0; i < 64*224*224; i++){
            output_temp_1[i] = (data_type_o)(0);
}
    ...
    conv_layer_new(64, 3, 128, 112, 112, 1, 1, output_temp_2,conv_weight_port, conv_bias_port, output_temp_1, shift_weight_conv_2_1, shift_bias_conv_2_1,0,0);
    for(int i = 0; i < 64*224*224; i++){
...
//}
    ...
    conv_max_pool_layer_new(128, 3, 2, 128, 112, 112, 56, 56, 1, 2, 1, output_temp_1,conv_weight_port, conv_bias_port, output_temp_2, shift_weight_conv_2_2, shift_bias_conv_2_2,0,0);
    for(int i = 0; i < 64*224*224; i++){
            output_temp_1[i] = (data_type_o)(0);
}
...
//}
    ...
    conv_max_pool_layer_new(256, 3, 2, 256, 56, 56, 28, 28, 1, 2, 1, output_temp_2,conv_weight_port, conv_bias_port, output_temp_1, shift_weight_conv_3_3, shift_bias_conv_3_3,0,0);
    for(int i = 0; i < 64*224*224; i++){
            output_temp_2[i] = (data_type_o)(0);
}
    ...
    conv_layer_new(256, 3, 512, 28, 28, 1, 1, output_temp_1,conv_weight_port, conv_bias_port, output_temp_2, shift_weight_conv_4_1, shift_bias_conv_4_1,0,0);
    for(int i = 0; i < 64*224*224; i++){
            output_temp_1[i] = (data_type_o)(0);
}
    ...
    conv_layer_new(512, 3, 512, 28, 28, 1, 1, output_temp_2,conv_weight_port, conv_bias_port, output_temp_1, shift_weight_conv_4_2, shift_bias_conv_4_2,0,0);
    for(int i = 0; i < 64*224*224; i++){
            output_temp_2[i] = (data_type_o)(0);
}
...
//}
    ...
    conv_max_pool_layer_new(512, 3, 2, 512, 28, 28, 14, 14, 1, 2, 1, output_temp_1,conv_weight_port, conv_bias_port, output_temp_2, shift_weight_conv_4_3, shift_bias_conv_4_3,0,0);
    for(int i = 0; i < 64*224*224; i++){
            output_temp_1[i] = (data_type_o)(0);
}
...
//}
    ...
    conv_max_pool_layer_new(512, 3, 2, 512, 14, 14, 7, 7, 1, 2, 1, output_temp_2,conv_weight_port, conv_bias_port, output_temp_1, shift_weight_conv_5_3, shift_bias_conv_5_3,0,0);
    for(int i = 0; i < 64*224*224; i++){
            output_temp_2[i] = (data_type_o)(0);
}
	...
	F7.fc_layer_a(activation_type, output_temp_2, fc_weight_port+shift_weight_fc_7, fc_bias_port+shift_bias_fc_7, output_temp_1);
	...
	F8.fc_layer_a_no_activation(output_temp_1, fc_weight_port+shift_weight_fc_8, fc_bias_port+shift_bias_fc_8, output_temp_2);
