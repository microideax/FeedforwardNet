...
#pragma HLS INTERFACE m_axi depth=24576  port=output_temp_1
    ...
    //offset list
    int shift_weight_conv2 = 150;
    int shift_bias_conv2 = 6;
    ...
    //-------------------------------pooling acc 1 -------------------------------//
    //ave_pool_acc<data_type, data_type_w, data_type_o, 2, 4, 4> poolAcc1;
...
#pragma HLS allocation instances=conv_layer_acc limit=1 function
    ...
    //conv_layer_new(1, 5, 6, 28, 28, 1, 2, output_temp_1, conv_weight_port, conv_bias_port, output_temp_0, 0, 0, 0, 0);
    //conv_ave_pool_layer_new(3, 5, 3, 32, 32, 32, 16, 16, 1, 2, 2, output_temp_2, conv_weight_port, conv_bias_port, output_temp_1, 0, 0, 0, 0);
    //--------------------------pool layer 1---------------------------//
    //RESET_0: for(int addr = 0; addr < 96*32*32; addr++){
    //    output_temp_1[addr] = 0;
    //}
    //poolAcc1.ave_pool_layer_acc(6, 2, 14, 14, 2, 0, output_temp_0, output_temp_1);
    //ave_pool_layer_new(28, 28, 6, 2, 14, 14, 2, 0, output_temp_0, output_temp_1);
    conv_ave_pool_layer_new(1, 5, 2, 6, 28, 28, 14, 14, 1, 2, 2, output_temp_1, conv_weight_port, conv_bias_port, output_temp_0, 0, 0, 0, 0);
    ...
    //conv_layer_new(6, 5, 16, 10, 10, 1, 0, output_temp_0, conv_weight_port, conv_bias_port, output_temp_1, shift_weight_conv2, shift_bias_conv2, 0, 0);
    //RESET_2: for(int addr = 0; addr < 96*32*32; addr++){
    //    output_temp_0[addr] = 0;
    //}
    //--------------------------pool layer 2---------------------------//
    //poolAcc1.ave_pool_layer_acc(16, 2, 5, 5, 2, 0, output_temp_0, output_temp_1);
    //ave_pool_layer_new(10, 10, 16, 2, 5, 5, 2, 0, output_temp_1, output_temp_0);
    conv_ave_pool_layer_new(6, 5, 2, 16, 10, 10, 5, 5, 1, 2, 0, output_temp_0, conv_weight_port, conv_bias_port, output_temp_1, shift_weight_conv2, shift_bias_conv2, 0, 0);
...
//    fcAcc1.conv_layer_acc(16, 5, 10, 1, 1, 5, 0, output_temp_1, fc_weight_port, fc_bias_port, output_temp_0);
    ...
    conv_layer_new(16, 5, 10, 1, 1, 5, 0, output_temp_1, fc_weight_port, fc_bias_port, output_temp_0, 0, 0, 0, 0);
