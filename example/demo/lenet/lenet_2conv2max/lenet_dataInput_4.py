...
deploy_root = '/lenet_2conv2max_deploy.prototxt'
caffe_model_root = '/lenet_2conv2max_iter_10000.caffemodel'

# ************data_root :the location of data&weight output,automatic replacement*********
#data_root = caffe_root+'/test_image_output/4_origin/'
data_root = caffe_root+'/test_image_output/9/'
# ************img_root :the location of test image****************************************
#img_root = '/4_origin.bmp'
img_root = '/binarybmp/9.bmp'
...
print 'tan_c1:',net.blobs['tan_c1'].data.shape
if(os.path.exists(data_root+'lenet_2conv2max_batch_tan_c1.txt')):
	os.remove(data_root+'lenet_2conv2max_batch_tan_c1.txt')
f=open(data_root+'lenet_2conv2max_batch_tan_c1.txt','a')
for batch in range(1):
	for output_num in range(6):
		print >>f,'\n'+'batch='+str(batch)+' '+'output_num='+str(output_num)+' '+'\n'
		for height in range(28):
			print >>f,'\n'
			for width in range(28):
				f.write(str(net.blobs['tan_c1'].data[batch][output_num][height][width])+' ')
f.close()
...
print 'tan_s2:',net.blobs['tan_s2'].data.shape

if(os.path.exists(data_root+'lenet_2conv2max_tan_s2.txt')):
	os.remove(data_root+'lenet_2conv2max_tan_s2.txt')
f=open(data_root+'lenet_2conv2max_tan_s2.txt','a')
for batch in range(1):
	for output_num in range(6):
		print >>f,'\n'+'batch='+str(batch)+' '+'output_num='+str(output_num)+'\n'
		for height in range(14):
			print >>f,'\n'
			for width in range(14):
				f.write(str(net.blobs['tan_s2'].data[batch][output_num][height][width])+' ')
f.close()
...
print 'tan_c3:',net.blobs['tan_c3'].data.shape

if(os.path.exists(data_root+'lenet_2conv2max_tan_c3.txt')):
	os.remove(data_root+'lenet_2conv2max_tan_c3.txt')
f=open(data_root+'lenet_2conv2max_tan_c3.txt','a')
for batch in range(1):
	for output_num in range(16):
		print >>f,'\n'+'batch='+str(batch)+' '+'output_num='+str(output_num)+'\n'
		for height in range(10):
 			print >>f,'\n'
			for width in range(10):
 				f.write(str(net.blobs['tan_c3'].data[batch][output_num][height][width])+' ')
f.close()
...
print 'tan_s4_data:',net.blobs['tan_s4'].data.shape

if(os.path.exists(data_root+'lenet_2conv2max_tan_s4.txt')):
	os.remove(data_root+'lenet_2conv2max_tan_s4.txt')
f=open(data_root+'lenet_2conv2max_tan_s4.txt','a')
for batch in range(1):
	for output_num in range(16):
		print >>f,'\n'+'batch='+str(batch)+' '+'output_num='+str(output_num)+' '+'\n'
		for height in range(5):
 			print >>f,'\n'
			for width in range(5):
 				f.write(str(net.blobs['tan_s4'].data[batch][output_num][height][width])+' ')
...
if(os.path.exists(data_root+'lenet_2conv2max_tan_f5.txt')):
	os.remove(data_root+'lenet_2conv2max_tan_f5.txt')
f=open(data_root+'lenet_2conv2max_tan_f5.txt','a')
for batch in range(1):
  	for output_num in range(10):
  		f.write(str(net.blobs['tan_f5'].data[batch][output_num])+' ')
