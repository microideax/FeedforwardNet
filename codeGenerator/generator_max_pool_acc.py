...
def generate(generated_file_name="max_pool_acc_innerdf.h"):
	...
	str1 += '            cout << "Starting max_pool_acc_innerdf layer ...." << endl;' + EOL
	...
	str1 += "#if _C_DEBUG_MODE_" + EOL
	str1 += "#if _KERNEL_DEBUG_" + EOL
	str1 += '            cout << "Finished max_pool_acc_innerdf layer ...." << endl;' + EOL
