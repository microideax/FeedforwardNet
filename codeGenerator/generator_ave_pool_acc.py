...
def generate(generated_file_name="ave_pool_acc_innerpp.h"):
	...
	str1 += '            cout << "Starting ave_pool_acc_innerpp layer ...." << endl;' + EOL
	...
	str1 += "#if _C_DEBUG_MODE_" + EOL
	str1 += "#if _KERNEL_DEBUG_" + EOL
	str1 += '            cout << "Finished ave_pool_acc_innerpp layer ...." << endl;' + EOL
