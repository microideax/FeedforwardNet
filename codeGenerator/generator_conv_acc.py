...
def generate(generated_file_name="conv_acc_innerdf_1.h"):
	...
	str1 += "#if _BATCH_NORM_" + EOL
	str1 += "        , W *bn_mean, W *bn_denominator, " + EOL
	str1 += "#endif" + EOL
	str1 += "#if _SCALE_" + EOL
	str1 += "        W *scale_gamma, W *scale_beta" + EOL
	str1 += "#endif" + EOL
	str1 += "        ){" + EOL
	str1 += "        if (n >= N - Tn) {" + EOL
	...
	str1 += "#if _BATCH_NORM_" + EOL
	str1 += "                        out_buf[i - m][j - r][k - c] = " + EOL
	str1 += "                        (out_buf[i - m][j - r][k - c] - *(bn_mean + i)) * (*(bn_denominator + i));" + EOL
	str1 += "#endif" + EOL
	str1 += "#if _SCALE_" + EOL
	str1 += "                        out_buf[i - m][j - r][k - c] = " + EOL
	str1 += "                        out_buf[i - m][j - r][k - c] * (*(scale_gamma + i)) + (*(scale_beta + i));" + EOL
	str1 += "#endif" + EOL
	str1 += "                        if (act) {" + EOL
	for j in range(1,port_num + 1):
	...
	str1 += "#if _BATCH_NORM_" + EOL
	str1 += "                            ,bn_mean, bn_denominator," + EOL
	str1 += "#endif" + EOL
	str1 += "#if _SCALE_" + EOL
	str1 += "                            scale_gamma, scale_beta" + EOL
	str1 += "#endif" + EOL
	str1 += "                            );" + EOL
	str1 += "                    }" + EOL
	str1 += "                }" + EOL
